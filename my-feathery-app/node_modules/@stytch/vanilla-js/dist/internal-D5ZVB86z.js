...
var HeadlessB2BOAuthClient$1 = /*#__PURE__*/function () {
  function HeadlessB2BOAuthClient(_networkClient, _subscriptionService, _pkceManager, _dynamicConfig, _config, dfpProtectedAuth) {
    ...
    this.hubspot = {
      start: this.startOAuthFlow(exports.B2BOAuthProviders.HubSpot),
      discovery: {
        start: this.startDiscoveryOAuthFlow(exports.B2BOAuthProviders.HubSpot)
      }
    };
    this.slack = {
      start: this.startOAuthFlow(exports.B2BOAuthProviders.Slack),
      discovery: {
