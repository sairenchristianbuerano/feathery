...
var SubscriptionDataLayer = /*#__PURE__*/function () {
  ...
  return _createClass(SubscriptionDataLayer, [{
    ...
    value: function generateCookieOpts(_ref11) {
      var path = _ref11.path,
        domain = _ref11.domain,
        availableToSubdomains = _ref11.availableToSubdomains,
...
var BaseSubscriptionService = /*#__PURE__*/function () {
  function BaseSubscriptionService(_publicToken, _datalayer, _ref12) {
    var _this6 = this;
    var usingCustomApiEndpoint = _ref12.usingCustomApiEndpoint;
...
var B2BOneTapProvider = /*#__PURE__*/function () {
  function B2BOneTapProvider(_networkClient, _pkceManager) {
    ...
    this.createOnDiscoverySuccessHandler = function (_ref14) {
      var discoveryRedirectUrl = _ref14.discoveryRedirectUrl,
        onSuccess = _ref14.onSuccess,
        onError = _ref14.onError;
      return function (response) {
        return internal.__awaiter(_this10, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
    ...
    this.createOnSuccessHandler = function (_ref15) {
      var organizationId = _ref15.organizationId,
  ...
  return _createClass(B2BOneTapProvider, [{
        ...
        return _regeneratorRuntime().wrap(function _callee13$(_context13) {
          while (1) switch (_context13.prev = _context13.next) {
            case 0:
              ...
              return _context13.abrupt("return", this.googleClientID);
            case 2:
              _context13.next = 4;
            ...
            case 4:
              oneTapStartResp = _context13.sent;
    ...
    value: function submitGoogleOneTapTokenDiscovery(_ref16) {
      var credential = _ref16.credential,
        discoveryRedirectUrl = _ref16.discoveryRedirectUrl;
        ...
        return _regeneratorRuntime().wrap(function _callee14$(_context14) {
          while (1) switch (_context14.prev = _context14.next) {
            case 0:
              ...
              return this._config;
            case 3:
              _yield$this$_config = _context14.sent;
    ...
    value: function submitGoogleOneTapToken(_ref17) {
      var credential = _ref17.credential,
        organizationId = _ref17.organizationId,
        signupRedirectUrl = _ref17.signupRedirectUrl,
        loginRedirectUrl = _ref17.loginRedirectUrl;
        ...
        return _regeneratorRuntime().wrap(function _callee15$(_context15) {
          while (1) switch (_context15.prev = _context15.next) {
            case 0:
              ...
              return this._config;
            case 3:
              _yield$this$_config2 = _context15.sent;
      ...
      return internal.__awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee16() {
        ...
        return _regeneratorRuntime().wrap(function _callee16$(_context16) {
          while (1) switch (_context16.prev = _context16.next) {
            ...
            case 3:
              googleClientId = _context16.sent;
              _context16.next = 10;
              break;
            case 6:
              _context16.prev = 6;
            ...
            case 12:
              _context16.t1 = GoogleOneTapClient;
              _context16.next = 15;
              return loadGoogleOneTapClient();
            case 15:
              _context16.t2 = _context16.sent;
              _context16.t3 = googleClientId;
              client = new _context16.t1(_context16.t2, _context16.t3);
              return _context16.abrupt("return", {
                success: true,
                client: client
              });
...
var B2BIDPClient = /*#__PURE__*/_createClass(function B2BIDPClient(_networkClient) {
  var _this11 = this;
  _classCallCheck(this, B2BIDPClient);
  this._networkClient = _networkClient;
  this.oauthAuthorizeStart = function (data) {
    return internal.__awaiter(_this11, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee17() {
      return _regeneratorRuntime().wrap(function _callee17$(_context17) {
        while (1) switch (_context17.prev = _context17.next) {
          case 0:
            _context17.next = 2;
            return this._networkClient.fetchSDK({
              url: "/b2b/oauth/authorize/start",
              method: 'POST',
              body: data
            });
          case 2:
  ...
  this.oauthAuthorizeSubmit = function (data) {
    return internal.__awaiter(_this11, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee18() {
...
var StytchB2BHeadlessClient = /*#__PURE__*/_createClass(function StytchB2BHeadlessClient(_PUBLIC_TOKEN, options) {
  ...
  internal.checkPublicToken(_PUBLIC_TOKEN);
  ...
  this.onStateChange = function () {
    var _this12$_stateChangeC;
    return (_this12$_stateChangeC = _this12._stateChangeClient).onStateChange.apply(_this12$_stateChangeC, arguments);
  };
  var additionalTelemetryDataFn = function additionalTelemetryDataFn() {
    var _a, _b, _c, _d;
    return {
      stytch_member_id: (_b = (_a = _this12._dataLayer.state) === null || _a === void 0 ? void 0 : _a.member) === null || _b === void 0 ? void 0 : _b.member_id,
      stytch_member_session_id: (_d = (_c = _this12._dataLayer.state) === null || _c === void 0 ? void 0 : _c.session) === null || _d === void 0 ? void 0 : _d.member_session_id
    };
  };
  ...
  var idp = new B2BIDPClient(networkClient);
