export declare const SCAN_CONFIG: {
    readonly fps: 8;
    readonly rememberLastUsedCamera: true;
    readonly disableFlip: true;
    readonly aspectRatio: number;
    readonly useBarCodeDetectorIfSupported: true;
};
export declare const QR_SCANNER_LIB_URL = "https://unpkg.com/html5-qrcode";
